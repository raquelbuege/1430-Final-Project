...
ChatGPT was utilized during this project in order to set up the screens, navigation, and other cosmetic details. For a more thorough explanation please reach out to any group member to discuss our application in more detail. Widgets including the slider, toggle, and dropdown were also taken from the flutter documentation, which is cited in our works cited. 
